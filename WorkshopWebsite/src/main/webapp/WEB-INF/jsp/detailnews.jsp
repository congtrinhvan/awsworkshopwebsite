            ...
            <div class="container-fluid">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-7 text-center">
                                <h1 class="title font-bold"><%=request.getAttribute("newstitle") %></h1>
                                <input type="text" style="display: none;" id="idnews" value="<%=request.getAttribute("id") %>" name="">
                                <h6 class="subtitle" style="text-align:  justify;" id="text-change"><%=request.getAttribute("newscontent") %> 
                                </h6>
                                <h6 style="text-align:right; font-style: initial; font-size:14px;">Ngày tin tức: <%=request.getAttribute("newsdate") %></h6>
                            </div>
                        </div> 
                        <%
                        	if(session.getAttribute("admin")!=null){
                ...
                <div class="spacer ">
                    <div class="container feature30">
                        <div class="row">
                            <div class="col-md-12"><img src="<%=request.getAttribute("newsimage") %>" class="rounded img-responsive" alt="wrappixel" /></div>
